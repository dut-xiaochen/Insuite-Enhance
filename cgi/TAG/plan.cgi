...
<table cellpadding="0" cellspacing="0" class="title_list">
    <tr>
        <td width="1250" align="left"><font size="4"><b>&lt;@{[t_(' 継続施策 ')]}&gt</b></font></td>
    ...
    <tbody id="continue_strategy_container">
        ...
        <script type="text/template" id="continue_strategy_tmpl">
        	<tr id="a_line_{{id}}" class="{{odd_or_even}}" >
            	<td id="a_sbutton_{{id}}" onmouseover="lineOver('{{id}}','a')" onmouseout="lineOut('{{id}}','{{odd_or_even}}','a')" style="text-align:center;"><input type="submit" name="" value="@{[t_('編集')]}" onclick="editPlan('{{strategy_code}}','{{record_id}}',1)"></td>
    ...
    <tbody id="new_strategy_container">
        ...
        <script type="text/template" id="new_strategy_tmpl">
        	<tr id="b_line_{{id}}" class="{{odd_or_even}}" >
            	<td id="b_sbutton_{{id}}" onmouseover="lineOver('{{id}}','b')" onmouseout="lineOut('{{id}}','{{odd_or_even}}','b')" style="text-align:center;"><input type="submit" name="" value="@{[t_('編集')]}" onclick="editPlan('{{strategy_code}}','{{record_id}}')"></td>
    ...
    <tbody id="challenge_strategy_container">
        ...
        <script type="text/template" id="challenge_strategy_tmpl">
        	<tr id="c_line_{{id}}" class="{{odd_or_even}}" >
            	<td id="c_sbutton_{{id}}" onmouseover="lineOver('{{id}}','c')" onmouseout="lineOut('{{id}}','{{odd_or_even}}','c')" style="text-align:center;"><input type="submit" name="" value="@{[t_('編集')]}" onclick="editPlan('{{strategy_code}}','{{record_id}}')"></td>
